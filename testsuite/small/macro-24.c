/* { dg-options "-DCE_EXTRACT_FUNCTIONS=f -DCE_EXPORT_SYMBOLS=OSSL_CMP_PROTECTEDPART_it _DCE_NO_STRONG_RENAME" }*/
/* { dg-xfail }*/
...
/* { dg-final { scan-tree-dump "#define OSSL_CMP_PROTECTEDPART_it \(\*klpe_OSSL_CMP_PROTECTEDPART_it\)\(\)" } } */
